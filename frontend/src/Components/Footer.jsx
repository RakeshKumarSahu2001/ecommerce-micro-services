    ...
    return (
        <section className="py-10 bg-gray-50 sm:pt-16">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:col-span-2 lg:grid-cols-3 gap-y-16 gap-x-12">
                    <div className="col-span-1 md:col-span-1 lg:col-span-1 lg:pr-8">
                        <img className="w-32" src={shopnow} alt="shopnow logo" />
                    ...
                    <div className="col-span-1 md:col-span-1 lg:col-span-1">
                        <h3 className="text-sm font-semibold tracking-widest text-gray-400 uppercase">Company</h3>

                        <ul className="mt-3 space-y-4">
                            <li>
                                <Link to="/" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Home</Link>
                            </li>
                    ...
                    <div className="col-span-2 md:col-span-2 lg:col-span-1 lg:pl-8">
                        <h3 className="text-sm font-semibold tracking-widest text-gray-400 uppercase">Shopnow</h3>
                        <p className="text-base text-justify leading-relaxed text-gray-600 mt-3">
                            ShopNow is a modern eCommerce application built with the MERN stack, replacing MongoDB with MySQL for robust relational data management. It offers seamless user experiences with React, a Node.js and Express backend, and MySQL's structured database capabilities for efficient product, user, and order management.</p>
                    </div>
                </div>
